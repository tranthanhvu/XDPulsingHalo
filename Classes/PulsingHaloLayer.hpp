...
class PulsingHaloLayer: public CircleLayer {
    
public:
    PulsingHaloLayer();
    ~PulsingHaloLayer();
    
    static PulsingHaloLayer* create(const cocos2d::Color4B &color = Color4B(0, 122, 255, 255), float radius = 300, int repeatCount = 0);
